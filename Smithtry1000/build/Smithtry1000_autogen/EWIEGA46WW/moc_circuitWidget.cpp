...
QT_MOC_LITERAL(3, 23, 8), // "Element*"
QT_MOC_LITERAL(4, 32, 5), // "tuned"
QT_MOC_LITERAL(5, 38, 4), // "path"
QT_MOC_LITERAL(6, 43, 7), // "getLeft"
QT_MOC_LITERAL(7, 51, 13), // "RemoveElement"
QT_MOC_LITERAL(8, 65, 9) // "RemoveAll"

    },
    "CircuitWidget\0clicked\0\0Element*\0tuned\0"
    "path\0getLeft\0RemoveElement\0RemoveAll"
};
...
void CircuitWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< Element*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->getLeft(); break;
        case 2: _t->RemoveElement((*reinterpret_cast< Element*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (CircuitWidget::*)(Element * , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CircuitWidget::clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CircuitWidget::clicked(Element * _t1, QString _t2)
{
