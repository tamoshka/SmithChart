...
void Smithtry1000::SwitchElementName(QString& name, bool& mood)
{
...
{
    if (tempCircuit.pointIndexes.contains(SystemParameters::allpointindex))
    {
