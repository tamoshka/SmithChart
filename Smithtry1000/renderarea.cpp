...
QPointF RenderArea::compute_real(double t)
{
    double cos_t = cos(t);
    double sin_t = sin(t);
...
QPointF RenderArea::compute_realParallel(double t)
{
    double cos_t = cos(t);
    double sin_t = sin(t);
...
QPointF RenderArea::compute_imaginary(double t)
{
    double cos_t = cos(t);
    double sin_t = sin(t);
...
QPointF RenderArea::compute_imaginaryParallel(double t)
{
    double cos_t = cos(t);
    double sin_t = sin(t);
    double x;
